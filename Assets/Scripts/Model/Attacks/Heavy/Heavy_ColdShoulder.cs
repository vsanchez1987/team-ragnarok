...
namespace FightGame
{
	public class Heavy_ColdShoulder: Attack_Melee
	{
		...
		public override void Init(){
			...
			GameObject.Destroy(this.fire1, 0.7f);
			GameObject.Destroy(this.fire2, 0.7f);
		...
		{
			this.fire1.transform.position = this.attackOwner.joints["l_ball_jnt 2"].position;
			this.fire2.transform.position = this.attackOwner.joints["r_balr_jnt 2"].position;
		}
	}
}
