...
namespace FightGame
{
	public class Fighter_Amaterasu : A_Fighter
	{
		...
		{			
			...
			this.actionsCommandMap[ActionCommand.SPECIAL] 			= new Amaterasu_RisingSun(this.animationNameMap[FighterAnimation.SPECIAL_ATTACK], this, 1.75f);
			this.actionsCommandMap[ActionCommand.SPECIAL_FORWARD] 	= new Amaterasu_RisingSun(this.animationNameMap[FighterAnimation.SPECIAL_FORWARD_ATTACK], this, 1.75f);
			this.actionsCommandMap[ActionCommand.SPECIAL_BACK] 		= new Amaterasu_RisingSun(this.animationNameMap[FighterAnimation.SPECIAL_BACK_ATTACK], this, 1.75f);
			this.actionsCommandMap[ActionCommand.SPECIAL_UP] 		= new Amaterasu_RisingSun(this.animationNameMap[FighterAnimation.SPECIAL_UP_ATTACK], this, 1.75f);
			this.actionsCommandMap[ActionCommand.SPECIAL_DOWN] 		= new Amaterasu_RisingSun(this.animationNameMap[FighterAnimation.SPECIAL_DOWN_ATTACK], this, 1.75f);
		}
	}
}
